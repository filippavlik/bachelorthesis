...
namespace AdminPart.Services.RefereeServices
{
    ...
    {
        /// <summary>
        /// Processes a list of referees and their availability in relation to matches and transfers,
        ...
        /// <summary>
        /// Processes a single referee's availability in relation to matches and transfers,
        ...
        /// <summary>
        /// Calculates points or scores for referees based on previous and current match delegations and travel distances.
        /// </summary>
        ...
        /// <returns>Dictionary mapping referee IDs to tuples containing points and additional info about penalties</returns>
